...
def check_dependencies():
    ...
    if not os.path.isdir(codet_path):
        ...
        # in correct path
        # print dir
        print(os.getcwd(), "banana")
        subprocess.run(
            [
                "python3",
                "tools/get_coco_zeroshot_oriorder.py",
                "--data_path",
                "datasets/coco/zero-shot/instances_train2017_seen_2.json",
            ]
        )
        ...
        subprocess.run(
            [
                ...
                "tools/get_coco_zeroshot_oriorder.py",
                "--data_path",
                "datasets/coco/zero-shot/instances_val2017_all_2.json",
            ]
        )
